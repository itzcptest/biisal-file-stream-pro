...
🔻 <a href="{}">Fast Download</a>
🔺 <a href="{}">Watch Online</a>

‣ ɢᴇᴛ <a href="https://t.me/FilmZone_Official">ᴍᴏʀᴇ ғɪʟᴇs</a></b> 🌸"""
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Support [Support](https://t.me/Itzmecp) They Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ Support** [Support](https://t.me/Itzmecp)",
